  ...
  if (process.env.NODE_ENV === 'production') {
    ...
    googletag.cmd.push(function () {
      ...
      gptAdSlots[0] = googletag
        .defineSlot('/21735668613/shadowlands-prepatch-hd_top', [728, 90], 'a-1534303848220-0-d')
        .defineSizeMapping(topBotMapping.build())
        .addService(googletag.pubads())
      gptAdSlots[1] = googletag
        .defineSlot('/21735668613/shadowlands-prepatch-hd_side', [160, 600], 'a-1534304579228-0-d')
        .defineSizeMapping(sideMapping.build())
        .addService(googletag.pubads())
      gptAdSlots[2] = googletag
        .defineSlot('/21735668613/shadowlands-prepatch-hd_bot', [728, 90], 'a-1534304680941-0-d')
        .defineSizeMapping(topBotMapping.build())
        .addService(googletag.pubads())
