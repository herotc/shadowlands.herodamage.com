...
const ConsumablesSimulationTemplate = (props) => (
  <StackedChartLayout {...props} chartTitle="Consumables % DPS Gain per Item Levels">
    <div>
      <p><Trans>Here, you can compare expected DPS increase from consumables.</Trans></p>
      <p><Trans>In order to compare consumables with this chart, look for the end of the bars corresponding to the
      ...
      <b>depends heavily</b> on the used profile with its talents, its gear, etc. and is rather giving an outlook.
        If your character is different from the setup used here, personal simulations are recommended.</Trans></p>
    </div>
  </StackedChartLayout>
)

ConsumablesSimulationTemplate.propTypes = {
  data: PropTypes.object.isRequired,
  i18nPlugin: PropTypes.object
}

export default ConsumablesSimulationTemplate

export const query = graphql`
  query ConsumablesSimulation($lang: String!, $wowClass: String!, $simulationType: String!, $fightStyle: String!, $tier: String!, $spec: String!, $variation: String!) {
