...
const SoulbindsSimulationTemplate = (props) => (
  <StackedChartLayout {...props} chartTitle="Soulbinds % DPS Gain per Item Levels">
    <div>
      <p><Trans>Here, you can compare expected DPS increase from soulbinds.</Trans></p>
      <p><Trans>In order to compare soulbinds with this chart, look for the end of the bars corresponding to the
...
SoulbindsSimulationTemplate.propTypes = {
  data: PropTypes.object.isRequired,
  i18nPlugin: PropTypes.object
}

export default SoulbindsSimulationTemplate

export const query = graphql`
  query SoulbindsSimulation($lang: String!, $wowClass: String!, $simulationType: String!, $fightStyle: String!, $tier: String!, $spec: String!, $variation: String!) {
