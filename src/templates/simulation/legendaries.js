...
const LegendariesSimulationTemplate = (props) => (
  <StackedChartLayout {...props} chartTitle="Legendaries % DPS Gain per Item Levels">
    <div>
      <p><Trans>Here, you can compare expected DPS increase from legendaries.</Trans></p>
      <p><Trans>In order to compare legendaries with this chart, look for the end of the bars corresponding to the
...
LegendariesSimulationTemplate.propTypes = {
  data: PropTypes.object.isRequired,
  i18nPlugin: PropTypes.object
}

export default LegendariesSimulationTemplate

export const query = graphql`
  query LegendariesSimulation($lang: String!, $wowClass: String!, $simulationType: String!, $fightStyle: String!, $tier: String!, $spec: String!, $variation: String!) {
